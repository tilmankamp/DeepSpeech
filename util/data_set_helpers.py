...
class SwitchableDataSet(object):
    ...
    def next_batch(self):
        source, source_lengths, target, target_lengths = self._queue.dequeue_many(self._data_set._batch_size)
        sparse_labels = ctc_label_dense_to_sparse(target, target_lengths, self._data_set._batch_size)
